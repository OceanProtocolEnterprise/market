export type RuntimeConfig = {
  ...
  NEXT_PUBLIC_DFNS_ORG_ID?: string
  NEXT_PUBLIC_DFNS_RP_ID?: string
  NEXT_PUBLIC_DFNS_WALLET_ID?: string
...
const runtimeConfig: RuntimeConfig = (() => {
  const baseConfig: RuntimeConfig = {
    ...
    NEXT_PUBLIC_DFNS_ORG_ID: process.env.NEXT_PUBLIC_DFNS_ORG_ID,
    NEXT_PUBLIC_DFNS_RP_ID: process.env.NEXT_PUBLIC_DFNS_RP_ID,
    NEXT_PUBLIC_DFNS_WALLET_ID: process.env.NEXT_PUBLIC_DFNS_WALLET_ID,
